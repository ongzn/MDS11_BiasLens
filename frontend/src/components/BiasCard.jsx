  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl shadow-md">
      <motion.div
        ...
        className="w-full min-h-[450px] flex flex-col justify-between text-sm"
      >
              ...
              <React.Fragment key={idx}>
                <div className="relative">
                  <img
                    ...
                    className="w-full h-64 object-cover rounded-tl-xl"
                  />
                ...
                <div className="relative">
                  <img
                    ...
                    className="w-full h-64 object-cover rounded-tr-xl"
                  />
                  <div className="absolute bottom-0 left-0 bg-gray-900/70 text-white px-2 py-1 text-xs">
                    Transformed
                  </div>
        ...
        <div className="p-4 text-black">
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2 mt-3">
              <div className="bg-black-50 p-2 rounded text-black-700 h-full">
